...
const resources = {
  ...
  "support_chat_description": "Свяжитесь с нами через виджет чата на главной странице",
      ...
      "smart_brief_intro": "Заполните бриф. Обязательные поля: имя, фамилия, почта, телефон.",
      ...
      "smart_design_offer": "Ветка проектирования: предложение → бриф → договор → инвойс → выполнение работ.",
      "smart_fill_brief": "Заполнить бриф",
...
Технология ЧПУ фрезеровки незаменима в производстве мебели, наружной рекламы и сложных дизайнерских элементов.`
  ...
  "support_chat_description": "Contact us via the chat widget on the home page",
      ...
      "smart_brief_intro": "Fill in the brief. Required fields: first name, last name, email, phone.",
      ...
      "smart_design_offer": "Design branch: offer → brief → contract → invoice → work.",
      "smart_fill_brief": "Fill brief",
...
CNC milling technology is indispensable in the production of furniture, outdoor advertising, and complex design elements.`
  ...
  "support_chat_description": "დაგვიკავშირდით ჩატის საშუალებით მთავარ გვერდზე",
      ...
      "smart_brief_intro": "შეავსეთ ბრიფი. სავალდებულო ველები: სახელი, გვარი, ელფოსტა, ტელეფონი.",
      ...
      "smart_design_offer": "პროექტირების გზა: შეთავაზება → ბრიфი → კონტრაქტი → ინვოისი → შესრულება.",
      "smart_fill_brief": "ბრიფის შევსება",
