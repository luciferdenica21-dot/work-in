...
const resources = {
  ru: {
    translation: {
      ...
      "Закрыть":"Закрыть",
      "service_soon": "Услуга скоро будет добавлена.",
  ...
  "support_chat_description": "Свяжитесь с нами через виджет чата на главной странице",
      ...
      "review_document": "Ознакомиться с документом",
      ...
      "chat_input_placeholder": "Текст...",
      "login_via": "Войти через",
      "err_file_too_large": "Файл слишком большой. Максимальный размер — 100 МБ",
      "err_files_too_large": "Файлы слишком большие. Максимальный размер: фото/видео 100MB, остальные 10MB.",
      "err_file_upload": "Ошибка загрузки файла",
      "err_files_upload": "Ошибка загрузки файлов",
      "err_order_create": "Ошибка при создании заказа",
      "confirm_delete": "Удалить сообщений?",
...
Технология ЧПУ фрезеровки незаменима в производстве мебели, наружной рекламы и сложных дизайнерских элементов.`
  ...
  en: {
    translation: {
      ...
      "Закрыть":"Close",
      "service_soon": "Service coming soon.",
  ...
  "support_chat_description": "Contact us via the chat widget on the home page",
      ...
      "err_file_too_large": "File is too large. Maximum size — 100 MB",
      "err_files_too_large": "Files are too large. Max size: photo/video 100MB, others 10MB.",
      "err_file_upload": "File upload error",
      "err_files_upload": "Files upload error",
      "err_order_create": "Error creating order",
      "confirm_delete": "Delete messages?",
...
CNC milling technology is indispensable in the production of furniture, outdoor advertising, and complex design elements.`
  ...
  ka: {
    translation: {
      ...
      "Закрыть":"დახურვა",
      "service_soon": "სერვისი მალე დაემატება.",
  ...
  "support_chat_description": "დაგვიკავშირდით ჩატის საშუალებით მთავარ გვერდზე",
      ...
      "review_document": "დოკუმენტის გაცნობა",
      ...
      "chat_offline": "Offline",
      "chat_typing": "Typing…",
      "chat_input_placeholder": "ტექსტი...",
      "login_via": "შესვლა",
      "err_file_too_large": "ფაილი ძალიან დიდია. მაქსიმუმი — 100 MB",
      "err_files_too_large": "ფაილები ძალიან დიდია. მაქს: ფოტო/ვიდეო 100MB, სხვა 10MB.",
      "err_file_upload": "ფაილის ატვირთვის შეცდომა",
      "err_files_upload": "ფაილების ატვირთვის შეცდომა",
      "err_order_create": "შეკვეთის შექმნის შეცდომა",
      "confirm_delete": "Delete messages?",
