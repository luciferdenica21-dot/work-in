...
const resources = {
  ru: {
    translation: {
      ...
      "order_choose_service": "Выберите услугу",
  ...
  "support_chat_description": "Свяжитесь с нами через виджет чата на главной странице",
      ...
      "CANCEL": "Отмена",
      "smart_panel_title": "ИИ-ПОМОЩНИК",
      "smart_greeting": "Здравствуйте! Я интеллектуальный помощник Connector. Хотите пройти быстрый сценарий оформления заказа или связаться с менеджером?",
      "smart_start_ai": "🤖 Запустить ИИ‑Помощника",
      "smart_contact_manager": "👤 Связаться с менеджером",
      "smart_manager_enabled": "Режим свободного общения включён. Напишите сообщение менеджеру.",
      "smart_manager_soon": "Менеджер скоро ответит.",
      "smart_docs_review_notice": "Документы рассмотрят и свяжутся с вами.",
      "smart_refresh_ai": "🔄 Обновить ИИ",
      "smart_close": "Закрыть ИИ",
      "smart_close_confirm": "Закрыть ИИ‑помощника? Все данные и шаги будут удалены.",
      "smart_closed": "ИИ‑помощник закрыт. Можно запустить заново в любой момент.",
      "smart_reason_contact_manager": "Переход к менеджеру",
      "smart_reason_consult_online": "Онлайн‑консультация",
      "smart_reason_no_reference": "Нет референса — нужна помощь в сборе данных",
      "smart_reason_contract_ready": "Договор подготовлен к подписанию",
      "smart_help_collect_reference": "Помогите собрать данные",
      "smart_brief_intro": "Данные о заказчике. Обязательные поля: имя, фамилия, почта, телефон.",
      "smart_brief_first_name": "Имя *",
      "smart_brief_last_name": "Фамилия *",
      "smart_brief_email": "Почта *",
      "smart_brief_phone": "Телефон *",
      "smart_brief_required": "Заполните все обязательные поля брифа.",
      "smart_brief_pdf_title": "Бриф клиента (структурированные данные)",
      "smart_brief_pdf_section_client": "1) Данные клиента",
      "smart_brief_pdf_section_meta": "2) Контекст",
      "smart_brief_pdf_section_services": "3) Выбранные услуги",
      "smart_brief_pdf_section_answers": "4) Ответы на вопросы",
      "smart_brief_pdf_section_files": "5) Приложенные файлы",
      "smart_special_wishes": "Особые пожелания (опишите текстом)…",
      "smart_order_pdf_title": "Заказ (структурированные данные)",
      "smart_order_pdf_section_client": "1) Данные клиента",
      "smart_order_pdf_section_services": "2) Выбранные услуги",
      "smart_order_pdf_section_answers": "3) Ответы на вопросы",
      "smart_order_pdf_section_wishes": "4) Особые пожелания",
      "smart_order_pdf_section_files": "5) Приложенные файлы",
      "smart_contract_template": "ДОГОВОР НА ПРОЕКТИРОВАНИЕ (черновик)\n\n1. Стороны\nИсполнитель: Connector\nЗаказчик: {{firstName}} {{lastName}}, {{email}}, {{phone}}\n\n2. Предмет договора\nИсполнитель обязуется выполнить работы по проектированию/подготовке документации по запросу Заказчика.\n\n3. Сроки и стоимость\nСроки и стоимость согласуются с менеджером после анализа брифа.\n\n4. Передача результатов\nРезультаты передаются в электронном виде.\n\n5. Подписи\nПодписание выполняется через электронную подпись (e-signature).",
      "smart_input_locked": "Ввод заблокирован. Запустите ИИ‑Помощника или выберите «Связаться с менеджером».",
      "smart_q_specific": "У вас конкретный запрос?",
      "smart_specific_request": "Конкретный запрос",
      "smart_capabilities": "Описание возможностей",
      "smart_gallery_title": "Описание возможностей",
      "smart_gallery_body": "Мы можем помочь с проектированием, подбором технологии, подготовкой брифа и оформлением заказа. Выберите «Конкретный запрос», чтобы продолжить по сценарию.",
      "smart_back": "Назад",
      "smart_q_consult_or_tech": "Это консультация или конкретная технология?",
      "smart_production": "Производство",
      "smart_consultation": "Консультация",
      "smart_consult_sale": "Консультация помогает быстро определить технологию, материал и бюджет. Выберите формат консультации.",
      "smart_consult_format": "Формат консультации:",
      "smart_online": "Онлайн",
      "smart_offline": "Офлайн",
      "smart_consult_ready": "Готов заказать?",
      "smart_yes": "Да",
      "smart_no": "Нет",
      "smart_consult_end": "Будем рады видеть вас снова. Если появятся вопросы — напишите нам.",
      "smart_finish": "Завершить",
      "smart_project_entry": "Проектирование и оценка: выберите подходящий вариант.",
      "smart_project_have": "У вас есть проект?",
      "smart_have_project": "Есть проект",
      "smart_have_reference": "Есть референс",
      "smart_no_project": "Нет проекта",
      "smart_no_project_need_design": "Нет проекта (нужно проектирование)",
      "smart_project_need_correction": "Нужна коррекция проекта?",
      "smart_project_reference": "Есть референс?",
      "smart_prepare_reference": "Просьба подготовить референс и вернуться к этому шагу.",
      "smart_design_offer": "Ветка проектирования: предложение → сбор данных → оформление заказа.",
      "smart_fill_brief": "Данные о заказчике",
      "smart_design_contract": "Договор на проектирование",
      "smart_sign_contract": "Подписать договор",
      "smart_design_invoice": "Инвойс на проектирование",
      "smart_pay_invoice": "Оплатить инвойс",
      "smart_design_work": "Выполнение работ завершено. Переходим к выбору услуг.",
      "smart_continue_to_services": "К выбору услуг",
      "smart_select_services": "Выберите услуги (можно несколько):",
      "smart_continue": "Продолжить",
      "smart_pick_at_least_one": "Выберите хотя бы одну услугу, чтобы продолжить.",
      "smart_form_single": "Выбрана 1 услуга. Ответьте на вопросы формы №1.",
      "smart_form_multi": "Выбрано несколько услуг. Ответьте на вопросы формы №2.",
      "smart_upload_files": "Загрузить файлы",
      "smart_files": "Файлы сессии",
      "smart_remove": "Удалить",
      "smart_files_added": "Файлы добавлены: {{count}}",
      "smart_log_answer": "Ответ",
      "smart_log_service_added": "Добавлена услуга",
      "smart_log_service_removed": "Удалена услуга",
      "smart_option_custom": "Другое",
      "smart_custom_placeholder": "Опишите свой вариант…",
      "smart_finalize": "Финализация: сформируем карточку заказа и документы.",
      "smart_generate_order": "Сформировать заказ",
      "smart_order_processing": "Обработка заказа и подготовка документов...",
      "smart_order_prepared": "Новый сформированный заказ подготовлен и передан менеджеру.",
      "smart_order_sent": "Заказ отправлен менеджеру.",
      "smart_order_send_failed": "Не удалось отправить заказ менеджеру. Попробуйте позже или свяжитесь с менеджером.",
      "smart_help_question": "Могу ли я чем-то помочь?",
      "smart_help_comment_prompt": "Ваш комментарий менеджеру",
      "smart_help_comment_placeholder": "Ваш комментарий менеджеру…",
      "smart_manager_comment_prefix": "Комментарий клиента после оформления заказа:",
      "smart_help_send_comment": "Отправить",
      "smart_help_close_confirm": "Закрыть сессию ИИ? Вы уверены?",
      "smart_help_session_closed": "Сессия ИИ закрыта.",
      "smart_summary_pdf_title": "Заказ",
      "smart_summary_section_client": "1) Данные клиента",
      "smart_summary_section_services": "2) Выбранные услуги",
      "smart_summary_section_comments": "3) Комментарии (сроки, количество, материал)",
      "smart_summary_section_files": "4) Прикреплённые файлы",
      "smart_summary_file_service": "относится к",
      "smart_summary_order_desc": "Описание заказа",
      "smart_docs_ready": "Документы готовы",
      "smart_download_zip": "Скачать архив (ZIP)",
      "smart_download_order": "Скачать заказ (PDF)",
      ...
      "smart_deadline_month": "До 1 месяца",
      "smart_q_material": "Материал?",
      "smart_material_metal": "Металл",
      "smart_material_plastic": "Пластик",
      "smart_material_wood": "Дерево",
      "smart_q_quantity": "Количество?",
      "smart_qty_1": "1",
      "smart_qty_2_10": "2–10",
      "smart_qty_10_plus": "10+",
      "smart_q_priority": "Что важнее?",
      "smart_priority_price": "Цена",
      "smart_priority_speed": "Скорость",
      "smart_priority_quality": "Качество",
      "smart_coming_soon": "Скоро будет",
      "smart_svc_bending": "Гибочные работы по металлам",
      "smart_svc_laser_engraving": "Лазерная гравировка",
      "smart_svc_laser_cut_metal": "Лазерная резка металлов",
      "smart_svc_laser_cut_nonmetal": "Лазерная резка и гравировка неметаллических материалов",
      "smart_svc_powder_paint": "Порошковая окраска",
      "smart_svc_welding": "Сварка",
      "smart_svc_mech": "Традиционная механическая обработка",
      "smart_svc_cnc": "ЧПУ фрезеровка",
      "smart_svc_liquid_paint": "Жидкостная окраска",
      "smart_svc_materials": "Продажа материалов",
      "chat_online": "В сети",
      "chat_offline": "Не в сети",
      "chat_typing": "Печатает…",
      "chat_close_confirm_clear": "Закрыть чат? История переписки будет удалена на вашем устройстве.",
...
Технология ЧПУ фрезеровки незаменима в производстве мебели, наружной рекламы и сложных дизайнерских элементов.`
  ...
  en: {
    translation: {
      ...
      "order_choose_service": "Choose a service",
  ...
  "support_chat_description": "Contact us via the chat widget on the home page",
      ...
      "CANCEL": "Cancel",
      "smart_panel_title": "AI ASSISTANT",
      "smart_greeting": "Hello! I’m Connector’s smart assistant. Do you want to follow the guided order flow or contact a manager?",
      "smart_start_ai": "🤖 Start AI Assistant",
      "smart_contact_manager": "👤 Contact manager",
      "smart_manager_enabled": "Free chat mode enabled. Write a message to the manager.",
      "smart_manager_soon": "A manager will reply soon.",
      "smart_docs_review_notice": "Your documents will be reviewed and we will contact you.",
      "smart_refresh_ai": "🔄 Refresh AI",
      "smart_close": "Close AI",
      "smart_close_confirm": "Close the AI assistant? All data and steps will be cleared.",
      "smart_closed": "AI assistant is closed. You can start again anytime.",
      "smart_reason_contact_manager": "Transferred to manager",
      "smart_reason_consult_online": "Online consultation",
      "smart_reason_no_reference": "No reference — need help collecting data",
      "smart_reason_contract_ready": "Contract is ready for signing",
      "smart_help_collect_reference": "Help collect data",
      "smart_brief_intro": "Customer details. Required fields: first name, last name, email, phone.",
      "smart_brief_first_name": "First name *",
      "smart_brief_last_name": "Last name *",
      "smart_brief_email": "Email *",
      "smart_brief_phone": "Phone *",
      "smart_brief_required": "Please fill in all required brief fields.",
      "smart_brief_pdf_title": "Client brief (structured data)",
      "smart_brief_pdf_section_client": "1) Client details",
      "smart_brief_pdf_section_meta": "2) Context",
      "smart_brief_pdf_section_services": "3) Selected services",
      "smart_brief_pdf_section_answers": "4) Answers",
      "smart_brief_pdf_section_files": "5) Attached files",
      "smart_special_wishes": "Special wishes (describe in text)…",
      "smart_order_pdf_title": "Order (structured data)",
      "smart_order_pdf_section_client": "1) Client details",
      "smart_order_pdf_section_services": "2) Selected services",
      "smart_order_pdf_section_answers": "3) Answers",
      "smart_order_pdf_section_wishes": "4) Special wishes",
      "smart_order_pdf_section_files": "5) Attached files",
      "smart_contract_template": "DESIGN CONTRACT (draft)\n\n1. Parties\nProvider: Connector\nClient: {{firstName}} {{lastName}}, {{email}}, {{phone}}\n\n2. Scope\nProvider agrees to perform design/preparation work based on the Client’s brief.\n\n3. Terms and pricing\nTerms and pricing will be confirmed by the manager after reviewing the brief.\n\n4. Delivery\nResults are delivered electronically.\n\n5. Signatures\nSigning is performed via e-signature.",
      "smart_input_locked": "Input is locked. Start the AI Assistant or choose “Contact manager”.",
      "smart_q_specific": "Do you have a specific request?",
      "smart_specific_request": "Specific request",
      "smart_capabilities": "Capabilities",
      "smart_gallery_title": "Capabilities",
      "smart_gallery_body": "We can help with design, technology selection, brief preparation, and order creation. Choose “Specific request” to continue the guided flow.",
      "smart_back": "Back",
      "smart_q_consult_or_tech": "Is it a consultation or a specific technology?",
      "smart_production": "Production",
      "smart_consultation": "Consultation",
      "smart_consult_sale": "Consultation helps define technology, material, and budget faster. Choose a format.",
      "smart_consult_format": "Consultation format:",
      "smart_online": "Online",
      "smart_offline": "Offline",
      "smart_consult_ready": "Ready to order?",
      "smart_yes": "Yes",
      "smart_no": "No",
      "smart_consult_end": "We’ll be happy to see you again. If you have questions — message us.",
      "smart_finish": "Finish",
      "smart_project_entry": "Design and estimation: choose the option that fits you.",
      "smart_project_have": "Do you have a project?",
      "smart_have_project": "I have a project",
      "smart_have_reference": "I have a reference",
      "smart_no_project": "No project",
      "smart_no_project_need_design": "No project (need design)",
      "smart_project_need_correction": "Do you need corrections to the project?",
      "smart_project_reference": "Do you have a reference?",
      "smart_prepare_reference": "Please prepare a reference and return to this step.",
      "smart_design_offer": "Design branch: offer → collect details → place order.",
      "smart_fill_brief": "Customer details",
      "smart_design_contract": "Design contract",
      "smart_sign_contract": "Sign contract",
      "smart_design_invoice": "Design invoice",
      "smart_pay_invoice": "Pay invoice",
      "smart_design_work": "Work is completed. Moving to service selection.",
      "smart_continue_to_services": "Go to services",
      "smart_select_services": "Select services (multi-select):",
      "smart_continue": "Continue",
      "smart_pick_at_least_one": "Select at least one service to continue.",
      "smart_form_single": "1 service selected. Please answer Form #1.",
      "smart_form_multi": "2+ services selected. Please answer Form #2.",
      "smart_upload_files": "Upload files",
      "smart_files": "Session files",
      "smart_remove": "Remove",
      "smart_files_added": "Files added: {{count}}",
      "smart_finalize": "Finalization: we will create the order card and documents.",
      "smart_option_custom": "Other",
      "smart_custom_placeholder": "Describe your option…",
      "smart_generate_order": "Generate order",
      "smart_order_processing": "Processing order and preparing documents...",
      "smart_order_prepared": "A new formed order has been prepared and sent to the manager.",
      "smart_order_sent": "The order was sent to the manager.",
      "smart_order_send_failed": "Failed to send the order to the manager. Please try later or contact a manager.",
      "smart_help_question": "Can I help with anything?",
      "smart_help_comment_prompt": "Your comment to the manager",
      "smart_help_comment_placeholder": "Your comment to the manager…",
      "smart_manager_comment_prefix": "Client comment after order placement:",
      "smart_help_send_comment": "Send",
      "smart_help_close_confirm": "Close the AI session? Are you sure?",
      "smart_help_session_closed": "AI session closed.",
      "smart_summary_pdf_title": "Order",
      "smart_summary_section_client": "1) Client details",
      "smart_summary_section_services": "2) Selected services",
      "smart_summary_section_comments": "3) Comments (deadline, quantity, material)",
      "smart_summary_section_files": "4) Attached files",
      "smart_summary_file_service": "related to",
      "smart_summary_order_desc": "Order description",
      "smart_sign_act": "Sign acceptance act",
      "smart_sign_act_info": "Next step will be e-signature for the acceptance act.",
      "smart_q_deadline": "Deadline?",
      "smart_deadline_asap": "As soon as possible",
      "smart_deadline_week": "Up to 1 week",
      "smart_deadline_month": "Up to 1 month",
      "smart_q_material": "Material?",
      "smart_material_metal": "Metal",
      "smart_material_plastic": "Plastic",
      "smart_material_wood": "Wood",
      "smart_q_quantity": "Quantity?",
      "smart_qty_1": "1",
      "smart_qty_2_10": "2–10",
      "smart_qty_10_plus": "10+",
      "smart_q_priority": "What matters most?",
      "smart_priority_price": "Price",
      "smart_priority_speed": "Speed",
      "smart_priority_quality": "Quality",
      "smart_coming_soon": "Coming soon",
      "smart_svc_bending": "Metal bending works",
      "smart_svc_laser_engraving": "Laser engraving",
      "smart_svc_laser_cut_metal": "Laser cutting (metal)",
      "smart_svc_laser_cut_nonmetal": "Laser cutting & engraving (non-metals)",
      "smart_svc_powder_paint": "Powder coating",
      "smart_svc_welding": "Welding",
      "smart_svc_mech": "Conventional machining",
      "smart_svc_cnc": "CNC milling",
      "smart_svc_liquid_paint": "Liquid painting",
      "smart_svc_materials": "Materials sales",
      "chat_online": "Online",
      "chat_offline": "Offline",
      "chat_typing": "Typing…",
      "chat_close_confirm_clear": "Close chat? The conversation history will be deleted on your device.",
...
CNC milling technology is indispensable in the production of furniture, outdoor advertising, and complex design elements.`
  ...
  ka: {
    translation: {
      ...
      "Телефон или Email": "ტელეფონი ან ელ-ფოსტა",
      ...
      "order_choose_service": "აირჩიეთ სერვისი",
      ...
      "Вход": "შესვლა",
      "Выберите хотя бы одну услугу":"გთხოვთ აირჩიოთ მინიმუმ ერთი მომსახურება",
      "Ваша форма на заказ успешно отправлена":"თქვენი შეკვეთის ფორმა წარმატებით გაიგზავნა",
      "менеджер обязательно с вами свяжеться !!!":"მენეჯერი აუცილებლად დაგიკავშირდებათ!",
      "Пожалуйста, войдите в свой аккаунт, чтобы оформить заказ":"შეკვეთის გასაფორმებლად გთხოვთ შეხვიდეთ თქვენს ანგარიშში",
  ...
  "support_chat_description": "დაგვიკავშირდით ჩატის საშუალებით მთავარ გვერდზე",
      ...
      "CANCEL": "გაუქმება",
      "smart_panel_title": "AI ასისტენტი",
      "smart_greeting": "გამარჯობა! მე ვარ Connector-ის ინტელექტუალური ასისტენტი. გსურთ ნაბიჯ-ნაბიჯ შეკვეთის ფორმირება თუ მენეჯერთან დაკავშირება?",
      "smart_start_ai": "🤖 AI ასისტენტის დაწყება",
      "smart_contact_manager": "👤 მენეჯერთან დაკავშირება",
      "smart_manager_enabled": "თავისუფალი ჩატის რეჟიმი ჩართულია. დაწერეთ მენეჯერს.",
      "smart_manager_soon": "მენეჯერი მალე გიპასუხებთ.",
      "smart_docs_review_notice": "დოკუმენტებს განვიხილავთ და დაგიკავშირდებით.",
      "smart_refresh_ai": "🔄 AI-ის განახლება",
      "smart_close": "AI-ის დახურვა",
      "smart_close_confirm": "დავხუროთ AI ასისტენტი? ყველა მონაცემი და ნაბიჯი წაიშლება.",
      "smart_closed": "AI ასისტენტი დახურულია. შეგიძლიათ ხელახლა დაიწყოთ ნებისმიერ დროს.",
      "smart_reason_contact_manager": "მენეჯერთან გადართვა",
      "smart_reason_consult_online": "ონლაინ კონსულტაცია",
      "smart_reason_no_reference": "რეფერენსი არ არის — საჭიროა დახმარება მონაცემების შეგროვებაში",
      "smart_reason_contract_ready": "კონტრაქტი მზადაა ხელმოწერისთვის",
      "smart_help_collect_reference": "დაგვეხმარეთ მონაცემების შეგროვებაში",
      "smart_brief_intro": "დამკვეთის მონაცემები. სავალდებულო ველები: სახელი, გვარი, ელფოსტა, ტელეფონი.",
      "smart_brief_first_name": "სახელი *",
      "smart_brief_last_name": "გვარი *",
      "smart_brief_email": "ელფოსტა *",
      "smart_brief_phone": "ტელეფონი *",
      "smart_brief_required": "გთხოვთ შეავსოთ ბრიფის ყველა სავალდებულო ველი.",
      "smart_brief_pdf_title": "კლიენტის ბრიფი (სტრუქტურირებული მონაცემები)",
      "smart_brief_pdf_section_client": "1) კლიენტის მონაცემები",
      "smart_brief_pdf_section_meta": "2) კონტექსტი",
      "smart_brief_pdf_section_services": "3) არჩეული სერვისები",
      "smart_brief_pdf_section_answers": "4) პასუხები",
      "smart_brief_pdf_section_files": "5) მიმაგრებული ფაილები",
      "smart_special_wishes": "სურვილები/შენიშვნები (ტექსტით)…",
      "smart_order_pdf_title": "შეკვეთა (სტრუქტურირებული მონაცემები)",
      "smart_order_pdf_section_client": "1) კლიენტის მონაცემები",
      "smart_order_pdf_section_services": "2) არჩეული სერვისები",
      "smart_order_pdf_section_answers": "3) პასუხები",
      "smart_order_pdf_section_wishes": "4) სურვილები/შენიშვნები",
      "smart_order_pdf_section_files": "5) მიმაგრებული ფაილები",
      "smart_contract_template": "პროექტირების კონტრაქტი (შავი ვარიანტი)\n\n1. მხარეები\nშემსრულებელი: Connector\nდამკვეთი: {{firstName}} {{lastName}}, {{email}}, {{phone}}\n\n2. ხელშეკრულების საგანი\nშემსრულებელი ვალდებულია შეასრულოს პროექტირების/დოკუმენტაციის მომზადების სამუშაოები ბრიფის საფუძველზე.\n\n3. ვადები და ღირებულება\nვადები და ღირებულება დაზუსტდება მენეჯერთან ბრიფის განხილვის შემდეგ.\n\n4. გადაცემა\nშედეგები გადაეცემა ელექტრონულად.\n\n5. ხელმოწერა\nხელმოწერა შესრულდება ელექტრონული ხელმოწერით.",
      "smart_input_locked": "შეყვანა დაბლოკილია. დაიწყეთ AI ასისტენტი ან აირჩიეთ „მენეჯერთან დაკავშირება“.",
      "smart_q_specific": "გაქვთ კონკრეტული მოთხოვნა?",
      "smart_specific_request": "კონკრეტული მოთხოვნა",
      "smart_capabilities": "შესაძლებლობები",
      "smart_gallery_title": "შესაძლებლობები",
      "smart_gallery_body": "შეგვიძლია დაგეხმაროთ დიზაინში, ტექნოლოგიის შერჩევაში, ბрифის მომზადებასა და შეკვეთის გაფორმებაში. აირჩიეთ „კონკრეტული მოთხოვნა“ გაგრძელებისთვის.",
      "smart_back": "უკან",
      "smart_q_consult_or_tech": "კონსულტაციაა თუ კონკრეტული ტექნოლოგია?",
      "smart_production": "წარმოება",
      "smart_consultation": "კონსულტაცია",
      "smart_consult_sale": "კონსულტაცია დაგეხმარებათ სწრაფად განსაზღვროთ ტექნოლოგია, მასალა და ბიუჯეტი. აირჩიეთ ფორმატი.",
      "smart_consult_format": "კონსულტაციის ფორმატი:",
      "smart_online": "ონლაინ",
      "smart_offline": "ოფლაინ",
      "smart_consult_ready": "მზად ხართ შეკვეთაზე?",
      "smart_yes": "დიახ",
      "smart_no": "არა",
      "smart_consult_end": "მოხარული ვიქნებით ისევ გნახოთ. კითხვების შემთხვევაში მოგვწერეთ.",
      "smart_finish": "დასრულება",
      "smart_project_entry": "პროექტირება და შეფასება: აირჩიეთ შესაბამისი ვარიანტი.",
      "smart_project_have": "გაქვთ პროექტი?",
      "smart_have_project": "მაქვს პროექტი",
      "smart_have_reference": "მაქვს რეფერენსი",
      "smart_no_project": "პროექტი არ მაქვს",
      "smart_no_project_need_design": "პროექტი არ მაქვს (საჭიროა პროექტირება)",
      "smart_project_need_correction": "საჭიროა კორექცია პროექტში?",
      "smart_project_reference": "გაქვთ რეფერენსი?",
      "smart_prepare_reference": "გთხოვთ მოამზადოთ რეფერენსი და დაბრუნდეთ ამ ნაბიჯზე.",
      "smart_design_offer": "პროექტირების გზა: შეთავაზება → მონაცემების შეგროვება → შეკვეთის გაფორმება.",
      "smart_fill_brief": "დამკვეთის მონაცემები",
      "smart_design_contract": "პროექტირების კონტრაქტი",
      "smart_sign_contract": "კონტრაქტის ხელმოწერა",
      "smart_design_invoice": "პროექტირების ინვოისი",
      "smart_pay_invoice": "ინვოისის გადახდა",
      "smart_design_work": "სამუშაო დასრულდა. გადავდივართ მომსახურებების არჩევაზე.",
      "smart_continue_to_services": "სერვისების არჩევა",
      "smart_select_services": "აირჩიეთ სერვისები (შესაძლებელია რამდენიმე):",
      "smart_continue": "გაგრძელება",
      "smart_pick_at_least_one": "გთხოვთ აირჩიოთ მინიმუმ ერთი სერვისი.",
      "smart_form_single": "არჩეულია 1 სერვისი. უპასუხეთ ფორმა №1 კითხვებს.",
      "smart_form_multi": "არჩეულია რამდენიმე სერვისი. უპასუხეთ ფორმა №2 კითხვებს.",
      "smart_upload_files": "ფაილების ატვირთვა",
      "smart_files": "სესიის ფაილები",
      "smart_remove": "წაშლა",
      "smart_files_added": "დამატებულია ფაილები: {{count}}",
      "smart_finalize": "ფინალიზაცია: შევქმნით შეკვეთის ბარათს და დოკუმენტებს.",
      "smart_option_custom": "სხვა",
      "smart_custom_placeholder": "აღწერეთ თქვენი ვარიანტი…",
      "smart_generate_order": "შეკვეთის შექმნა",
      "smart_order_processing": "შეკვეთის დამუშავება და დოკუმენტების მომზადება...",
      "smart_order_prepared": "ახალი შეკვეთა მომზადდა და გადაეცა მენეჯერს.",
      "smart_order_sent": "შეკვეთა გაიგზავნა მენეჯერთან.",
      "smart_order_send_failed": "შეკვეთის გაგზავნა ვერ მოხერხდა. სცადეთ მოგვიანებით ან დაუკავშირდით მენეჯერს.",
      "smart_help_question": "შემიძლია რამით დაგეხმაროთ?",
      "smart_help_comment_prompt": "თქვენი კომენტარი მენეჯერს",
      "smart_help_comment_placeholder": "თქვენი კომენტარი მენეჯერს…",
      "smart_manager_comment_prefix": "კლიენტის კომენტარი შეკვეთის გაფორმების შემდეგ:",
      "smart_help_send_comment": "გაგზავნა",
      "smart_help_close_confirm": "დახუროთ AI სესია? დარწმუნებული ხართ?",
      "smart_help_session_closed": "AI სესია დაიხურა.",
      "smart_summary_pdf_title": "შეკვეთა",
      "smart_summary_section_client": "1) კლიენტის მონაცემები",
      "smart_summary_section_services": "2) არჩეული სერვისები",
      "smart_summary_section_comments": "3) კომენტარები (ვადები, რაოდენობა, მასალა)",
      "smart_summary_section_files": "4) მიმაგრებული ფაილები",
      "smart_summary_file_service": "ეხება",
      "smart_summary_order_desc": "შეკვეთის აღწერა",
      "smart_sign_act": "მიღება-ჩაბარების აქტის ხელმოწერა",
      "smart_sign_act_info": "შემდეგი ნაბიჯი იქნება ელექტრონული ხელმოწერა აქტზე.",
      "smart_q_deadline": "ვადები?",
      "smart_deadline_asap": "რაც შეიძლება სწრაფად",
      "smart_deadline_week": "1 კვირამდე",
      "smart_deadline_month": "1 თვემდე",
      "smart_q_material": "მასალა?",
      "smart_material_metal": "მეტალი",
      "smart_material_plastic": "პლასტიკი",
      "smart_material_wood": "ხე",
      "smart_q_quantity": "რაოდენობა?",
      "smart_qty_1": "1",
      "smart_qty_2_10": "2–10",
      "smart_qty_10_plus": "10+",
      "smart_q_priority": "რა არის უფრო მნიშვნელოვანი?",
      "smart_priority_price": "ფასი",
      "smart_priority_speed": "სისწრაფე",
      "smart_priority_quality": "ხარისხი",
      "smart_coming_soon": "მალე იქნება",
      "smart_svc_bending": "ლითონის ღუნვითი სამუშაოები",
      ...
      "smart_svc_liquid_paint": "სითხისებრი შეღებვა",
      "smart_svc_materials": "მასალების გაყიდვა",
      "chat_online": "ონლაინ",
      "chat_offline": "ოფლაინ",
      "chat_typing": "ბეჭდავს…",
      "chat_close_confirm_clear": "დახუროთ ჩატი? მიმოწერის ისტორია წაიშლება თქვენს მოწყობილობაზე.",
      ...
      "confirm_delete": "წავშალოთ შეტყობინებები?",
